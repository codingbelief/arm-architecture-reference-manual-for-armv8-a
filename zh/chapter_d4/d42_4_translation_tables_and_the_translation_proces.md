...
* [Mismatched memory attributes](#) 章节中描述的 mismatched attributes 规则，在 translation table walks 和 explicit memory accesses 场景与在两个不同的 explicit memory accesses 场景是相同的。
