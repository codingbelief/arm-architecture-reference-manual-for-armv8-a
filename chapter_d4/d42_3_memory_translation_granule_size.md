...
---
当 granule size 配置为 4KB 时，单次的 lookup 最多可以处理 9 个比特位。假设在一个具体实现中，input address 有 35 位，即 IA[34:0]，根据 Table D4-10 中的描述，translation 从 level 1 lookup 开始，第一次 lookup 处理 IA[34:30]，
