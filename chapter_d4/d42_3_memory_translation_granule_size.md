...
---
根据 Table D4-10 中的描述，当使用 4KB translation granule 时，从 level 1 lookup 开始，可以处理 39-bit 的 IA，其中 first lookup 处理 IA[39:30]。在 stage 2 translation 中，将 IA 拓展为 40 bits 时，first lookup
---
